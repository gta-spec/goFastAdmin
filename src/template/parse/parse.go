...
func Parse(name, text, leftDelim, rightDelim string) (map[string]*Tree, error) {
...
func (t *Tree) blockControl() Node {
	...
	block.startParse(t.lex, t.treeSet)
	var end Node
	...
	return t.newBlock(token.pos, token.line, name, pipe, block.Root)
}
