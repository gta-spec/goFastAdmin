...
<html>
    <head>
        {{template "index/view/common/meta.tpl" .}}
    ...
    <body>
        ...
        <footer class="footer" style="clear:both">
            <p class="copyright">Copyright&nbsp;©&nbsp;{{date timestamp "2006"}} {{.site.name|htmlentities}} All Rights Reserved <a href="https://beian.miit.gov.cn" target="_blank">{{.site.beian|htmlentities}}</a></p>
        </footer>

        {{template "index/view/common/script.tpl" .}}
